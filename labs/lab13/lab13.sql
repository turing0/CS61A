...
CREATE TABLE favpets AS
  SELECT pet, COUNT(pet) as tot FROM students GROUP BY pet ORDER BY tot desc, pet desc LIMIT 10;
...
CREATE TABLE bluedog_agg AS
  SELECT song, COUNT(song) as tot FROM bluedog_songs GROUP BY song ORDER BY tot desc, song desc;
