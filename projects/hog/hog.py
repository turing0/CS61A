...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls>0:
        ...
        scores += score
        num_rolls-=1
    return scores if not pig_out else 1
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==1:
            ...
            temp = take_turn(num_dices, score0, dice)
            score1 += temp
            if feral_hogs and abs(num_dices-pre1)==2:
                score1+=3
            pre1=temp
            ...
            temp = take_turn(num_dices, score1, dice)
            score0 += temp
            if feral_hogs and abs(num_dices-pre0)==2:
                score0+=3
            pre0=temp
    ...
    def say(score0,score1):
        if who==1:
            if score1-last_score>running_high:
                print(f"{score1-last_score} point(s)! That's the biggest gain yet for Player {who}")
        ...
        return announce_highest(who, score1, running_high) if who else announce_highest(who, score0, running_high)
    return say
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score+fb,opponent_score):
        ...
        return 0 if fb>=cutoff else num_rolls # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    return swap_strategy(score,opponent_score,6,5)  # Replace this statement
    # END PROBLEM 12
